...
const menuItems: TopNavbarElement[] = [
  { name: "Home", link: "/" },
      ...
      <UContainer>
        <div class="flex h-16 items-center justify-between">
          <NuxtLink to="/" class="flex items-center space-x-3">
            <UIcon name="i-fa6-solid-dice" class="text-primary-500 h-6 w-6" />
            <span class="text-xl font-bold">RNG</span>
          </NuxtLink>
          <div class="flex items-center space-x-4">
            <TopNavbar :menu-items="menuItems" />
          </div>
        </div>
      </UContainer>
    </header>
    ...
    >
      <UContainer
        ><div class="flex h-16 items-center justify-between gap-3">
          <div class="flex items-center space-x-4">
            <UIcon name="i-fa6-solid-dice"></UIcon><span>© 2023 RNG</span>
          </div>
          <div class="flex items-center space-x-4">
            <UButton
              variant="link"
              label="Impressum"
              @click="impressum = true"
            ></UButton>
            <UModal v-model="impressum">
              <UCard>
                <template #header>
                ...
                <template #footer>
                  <p>
                    Quelle:
                    <NuxtLink href="https://www.e-recht24.de"
                      >e-recht24.de</NuxtLink
                    >
                  </p></template
                >
              </UCard>
            ...
            <UButton
              ...
              @click="dsgvo = true"
            ></UButton>
            <UModal v-model="dsgvo"
              ><UCard>
                <template #header> <h1>DSGVO</h1></template>
                <div class="space-y-4">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      ben&ouml;tigen, haben Sie das Recht, statt der
                      L&ouml;schung die Einschr&auml;nkung der Verarbeitung
                    ...
                    <li>
                      ...
                      nicht feststeht, wessen Interessen &uuml;berwiegen, haben
                      Sie das Recht, die Einschr&auml;nkung der Verarbeitung
                      Ihrer personenbezogenen Daten zu verlangen.
                    </li>
                  </ul>
                  <p>
                  ...
                  <p>
                    ...
                    Schriftarten und Symbolen Font Awesome. Anbieter ist die
                  ...
                  <p>
                    ...
                    Servern von Font Awesome aufnehmen. Hierdurch erlangt Font
                    Awesome Kenntnis dar&uuml;ber, dass &uuml;ber Ihre
                    IP-Adresse diese Website aufgerufen wurde. Die Nutzung von
                    Font Awesome erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f
                    DSGVO. Wir haben ein berechtigtes Interesse an der
                    einheitlichen Darstellung des Schriftbildes auf unserer
                    Website. Sofern eine entsprechende Einwilligung abgefragt
                    wurde, erfolgt die Verarbeitung ausschlie&szlig;lich auf
                    Grundlage von Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs.
                  ...
                  <p>
                    Wenn Ihr Browser Font Awesome nicht unterst&uuml;tzt, wird
                    eine Standardschrift von Ihrem Computer genutzt.
                  </p>
                  <p>
                    Weitere Informationen zu Font Awesome finden Sie&nbsp;und in
                    der Datenschutzerkl&auml;rung von Font Awesome unter:
                    <a
                ...
                <template #footer
                  ><p>
                    Quelle:
                    <NuxtLink href="https://www.e-recht24.de"
                      >https://www.e-recht24.de</NuxtLink
                    >
                  </p></template
                ></UCard
              ></UModal
